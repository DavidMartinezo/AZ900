...
az vm create -n iaas-vm-amin -g GrupoRecursosIaaS --image Ubuntu2204 --admin-username dmartinez --admin-password Am0_Apr3nd3r$
...
az network vnet create -g GrupoRecursosIaaS -n IaaSVnet004 --address-prefix 10.0.0.0/16 --subnet-name dmartinezSubnet --subnet-prefixes 10.0.0.0/24
